    ...
    <div>
     ...
     <Form>
      ...
      <Form.Group className="mb-3" controlId="formStoreEmail">
        ...
        <Form.Control type="text" placeholder="매장 전화번호나 대표 전화번호를 입력해주세요" />
        <Form.Label>⦁ 확인을 위해 연락을 취할 수 있으니 정확하게 적어주시기 바랍니다. </Form.Label>
      </Form.Group>
      </Form>
      ...
      <div style={{ backgroundColor: 'lavender' }}>프로필 사진 들어갈 자리 역시나 색은 내 맘임</div>
      <div>매장 사진(선택)</div>
      <div>
      <Button variant='secondary'>사진 업로드 {'>'}</Button>
      </div>
      <div style={{ backgroundColor: 'lavender' }}>이미지 사진 들어갈 자리 이것도 색은 내 마음이지</div>
